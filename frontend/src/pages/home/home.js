          ...
          <div className="showcase">
            <div className="texts">
              ...
              <div className="stext">
                ...
                commodo suscipit pellentesque. Nam diam nisi, aliquet lacinia
                odio id, imperdiet rutrum est. Integer vel felis placerat,
                tempor odio non.
              </div>
        ...
        <div className="container">
          <div className="functionality">
            ...
            <div className="stext" style={{ width: "50vw" }}>
              ...
              at ex commodo, sagittis urna vitae, eleifend lectus. Nullam
              maximus sem.
            </div>
            <div className="grid">
          ...
          <div class="container">
            <div class="code-holder">
              ...
              <div className="stext-white" style={{ width: "50vw" }}>
                ...
                Phasellus at ex commodo, sagittis urna vitae, eleifend lectus.
                Nullam maximus sem.
              </div>
              <div className="code-row">
                <div className="code-div">
                  ...
                  <div className="stext-white">
                    ...
                    Elius saepe, voluptates quis enim incidunt obcaecati?
                  </div>
                </div>
        ...
        <div className="store">
          <div class="container">
            <div class="store-holder">
              <div className="ltext-white">
                BASMA is available for all devices
              </div>
              <div className="stext-white">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus
                vestibulum dictum maximus. In in arcu finibus, bibendum arcu sit
                amet, ultricies felis. Phasellus ante ante, aliquam quis mauris
                non, rutrum imperdiet elit. Curabitur rutrum ultricies
                condimentum. Praesent eu nunc ex.
              </div>
            ...
            <div class="tuned-holder">
              ...
              <div className="tuned-parts">
                <div className="tuned-text">
                  <div className="stext">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Vivamus vestibulum dictum maximus.
                  </div>
                  <div className="tuned-items">
                    <div className="purple">
                      <img alt="" src={formHouse} className="purple-icon" />
                    </div>
                    <div className="stext">
